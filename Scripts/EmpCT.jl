...
include("/home/amo/dev/sunzulab/API/multifreq/PCRBTG-VT-main/Functions/Correlation Estimators/HY/HYcorr.jl")

# Read in the data
prices = CSV.read("JSE_prices_2019-06-24_2019-06-28.csv", DataFrame)
times = CSV.read("JSE_times_2019-06-24_2019-06-28.csv", DatFrame)
volume = CSV.read("JSE_volume_2019-06-24_2019-06-28.csv", DataFrame)
...
# Read in the data
prices = CSV.read("JSE_prices_2019-06-24_2019-06-28.csv", DataFrame)
times = CSV.read("JSE_times_2019-06-24_2019-06-28.csv", DataFrame)
volume = CSV.read("JSE_volume_2019-06-24_2019-06-28.csv", DataFrame)
